...
function ReleaseNotes({onClose}){
  ...
  return (<Modal title={t("rel_title")} onClose={onClose}>
    <div className="muted" style={{fontSize:12,marginBottom:12}}>🕓 {t("rel_tz")}</div>
...
Object.assign(I18N.en,{ applyReco:"Apply AI suggestion", save_over:"⚠ Exceeds 43%", rel_title:"Release notes", rel_current:"Current", rel_tz:"All times in Saudi Arabia Standard Time (AST, UTC+3)" });
Object.assign(I18N.zh,{ applyReco:"应用 AI 建议", save_over:"⚠ 超出 43%", rel_title:"更新日志", rel_current:"当前", rel_tz:"时间均为沙特时间 (AST，UTC+3)" });
Object.assign(I18N.ar,{ applyReco:"تطبيق توصية الذكاء", save_over:"⚠ يتجاوز ٤٣٪", rel_title:"سجل الإصدارات", rel_current:"الحالي", rel_tz:"جميع الأوقات بتوقيت السعودية (AST، UTC+3)" });
