...
const harness = `
  ...
  R.recoSavings = scenarioSavings(computeAllocation({reallocatePct:0.15,capHighPct:0.12,boostLowPct:0.10,offPlanPct:0.08})).phase;
...
approx(results.recoSavings, 0.9e9, 1.6e9, "recommended scenario savings near BRD floor (~1.37B)");
